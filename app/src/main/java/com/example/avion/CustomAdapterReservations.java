...
public class CustomAdapterReservations extends ArrayAdapter<Avion> {
    ...
    public CustomAdapterReservations(@NonNull Context context, int resource, @NonNull List<Avion> objects, FragmentManager fragmentManager) {
        ...
        if (flight != null) {
            ...
            iconNavigate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    InfoReservationFragment infoFlightFragment = new InfoReservationFragment(flight);
                    FragmentTransaction transaction = fragmentManager.beginTransaction();
                    transaction.add(R.id.frame_layout_client, infoFlightFragment);
                    transaction.replace(R.id.frame_layout_client, infoFlightFragment);
                    transaction.commit();
