...
public class HomeClientFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        listView = view.findViewById(R.id.listeAvionClient);

        // Create a custom adapter with the custom layout for each item
        CustomAdapterClient adapter = new CustomAdapterClient(requireContext(), R.layout.adapter_item, flightList,getParentFragmentManager());
