...
public class CustomAdapterClient extends ArrayAdapter<Avion> {
    ...
    public CustomAdapterClient(@NonNull Context context, int resource, @NonNull List<Avion> objects, FragmentManager fragmentManager) {
        ...
        if (flight != null) {
            ...
            iconNavigate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    InfoAvionClientFragment infoFlightFragment = new InfoAvionClientFragment(flight);
